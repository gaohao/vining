...
public class ViningShellTopology {
    
    public static void main(String[] args) throws Exception {
		Logger logger = LogManager.getLogger(ViningShellTopology.class.getName());
    	logger.entry();
        ...
        builder.setBolt("bolt", new ViningShellCacheBolt("localhost", 6379), 12)
